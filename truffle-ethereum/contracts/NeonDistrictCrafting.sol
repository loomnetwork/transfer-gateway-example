...
contract NeonDistrictCrafting is ERCAdaptable, ERC1155Spike {// is ERC1155Spike, ERCAdaptable {

    // TODO I don't think this contract on the eth chain ultimately
    // a) needs to be about crafting;
    // b) needs most if any of the functionality currently in here.
    // c) when we get there all this stuff should live on loom and this contract
    //    should simply push assets to and from their own eth erc* contracts. For now though go both ways.
    ...
    // this is an erc721 deal...but I'm adapting it
    // for spike purposes
    function depositToGateway(uint[] _ids, uint[] _values) public {
        transfer(gatewayContract, _ids, _values);
        // TODO add safe transfer checks
